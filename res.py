...
def pilih_login():
    ...
    if peak =='':
        ...
        os.system("clear")
        print logo2
        print 'TYPE ANY 2 DIGIT NUMBER \n\n     \x1b[1;93m TYPE ANY CODE FROM :1 to 49'
        try:
    ...
    time.sleep(0.5)
    psb('⇛\033[1;92m PLEASE WAIT, PROCESS IS START ..')
    time.sleep(0.5)
    psb('⇛\033[1;92m TO STOP THIS PROCESS PRESS Ctrl THEN z')
    time.sleep(0.5)
    print 45*"\033[1;97m═"
    def main(arg):
        global cpb,oks
